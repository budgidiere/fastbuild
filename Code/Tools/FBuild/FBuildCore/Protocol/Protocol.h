...
enum { SERVER_STATUS_TIMEOUT = 50000 };		// server is dead if time elapses between updates	//@KS: Increased timeout to fix disconnections on WIFI
...
public:
    ...
    inline uint32_t GetNumJobsAvailable() const {
        return m_NumJobsAvailable;
    }
