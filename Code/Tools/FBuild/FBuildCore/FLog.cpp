...
static AStackString<72> g_ClearLineString(
    "\r                                                               \r");
...
// OutputProgress
//------------------------------------------------------------------------------
/*static*/ void FLog::OutputProgress(float time, float percentage,
                                     uint32_t numJobs, uint32_t numJobsActive,
  ...
  m_ProgressText.Append("    \b\b\b",
                        7); // extra whitespace when string shortens
